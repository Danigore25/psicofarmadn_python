...
if var in genotipos_cor:
    ...
    print("Escriba el nombre del gen: ")
    gene_name = input()
    print("Escriba el alelo 1 del gen ", gene_name)
    alelo1 = input()
    print("Escriba el alelo 2 del gen ", gene_name)
    alelo2 = input()
    pharm_geno(alelo1, gene_name)
    pharmgkb_dip(gene_name, alelo1, alelo2)
